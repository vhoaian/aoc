...
fn cal_distance(galaxy_idx_1: u32, galaxy_idx_2: u32, expanded_in_x: &Vec<u32>, expanded_in_y: &Vec<u32>, width: u32) -> u32 {
    ...
    let mut distance_in_x = galaxy_1_x - galaxy_2_x;
    let mut distance_in_y = galaxy_1_y - galaxy_2_y;
